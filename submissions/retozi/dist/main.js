...
/***/ function(module, exports, __webpack_require__) {
	...
	var fluxInstance_1 = __webpack_require__(165);
	var ReactDOM = __webpack_require__(166);
	ReactDOM.render(React.createElement(App_1.App, { store: fluxInstance_1.store }), document.getElementsByClassName("app-container")[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Actions_1 = __webpack_require__(162);
	...
	var App = (function (_super) {
	    ...
	    App.prototype.stateSelector = function (allState) {
	        var actionCreator = new Flux.ActionCreator(this.props.store);
	        return {
	    ...
	    App.prototype.componentDidMount = function () {
	        ...
	        this.socket.addEventListener("message", function (event) {
	            var actionCreator = new Flux.ActionCreator(_this.props.store);
	            var data = JSON.parse(event.data);
	            actionCreator.write(new Actions_1.RECEIVE_OBI_WORLD(data.id, data.name));
	        });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Flux = __webpack_require__(4);
	var Actions_1 = __webpack_require__(162);
	(function (SithLordStatus) {
	    SithLordStatus[SithLordStatus["ABSENT"] = 0] = "ABSENT";
	    SithLordStatus[SithLordStatus["PENDING"] = 1] = "PENDING";
	    SithLordStatus[SithLordStatus["PRESENT"] = 2] = "PRESENT";
	})(exports.SithLordStatus || (exports.SithLordStatus = {}));
	var SithLordStatus = exports.SithLordStatus;
	function emptySithLord() {
	    return {
	        apprenticeUrl: null,
	        masterUrl: null,
	        name: null,
	...
	exports.emptySithLord = emptySithLord;
	function twoAbsentSithLords() {
	    return [emptySithLord(), emptySithLord()];
	}
	exports.twoAbsentSithLords = twoAbsentSithLords;
	...
	function someArePending(lords) {
	    return lords.some(function (l) { return l.status === SithLordStatus.PENDING; });
	}
	exports.someArePending = someArePending;
	function cancel() {
	    var lords = [];
	    for (var _i = 0; _i < arguments.length; _i++) {
	        lords[_i - 0] = arguments[_i];
	    }
	    for (var _a = 0; _a < lords.length; _a++) {
	        var l = lords[_a];
	...
	function writeMaster(state, lord, apprenticeId) {
	    return state.set(function (s) {
	        var writeIndex = indexOfLord(s, apprenticeId) - 1;
	        if (writeIndex < 0) {
	            return s;
	        }
	        s[writeIndex] = lord;
	...
	function writeApprentice(state, lord, masterId) {
	    return state.set(function (s) {
	        var writeIndex = indexOfLord(s, masterId) + 1;
	...
	exports.writeApprentice = writeApprentice;
	function writeSidious(state, sidious) {
	    return state.set(function (s) {
	        s[0] = sidious;
	        return s;
	    });
	...
	function fetchApprenticeIfNeeded(lords, actionCreator) {
	    ...
	    for (var _i = 0, _a = lords.reverse(); _i < _a.length; _i++) {
	        ...
	        if (l.status === SithLordStatus.PRESENT) {
	            if (l.apprenticeUrl) {
	                actionCreator.send(new Actions_1.GET_SITH_APPRENTICE(l.apprenticeUrl, l.id));
	            }
	            return;
	        }
	    }
	...
	function fetchMasterIfNeeded(lords, actionCreator) {
	    ...
	    for (var _i = 0; _i < lords.length; _i++) {
	        ...
	        if (l.status === SithLordStatus.PRESENT) {
	            if (l.masterUrl) {
	                actionCreator.send(new Actions_1.GET_SITH_MASTER(l.masterUrl, l.id));
	            }
	            return;
	        }
	    }
	}
	function fetchSidiousIfNeeded(lords, actionCreator) {
	    if (lords.every(function (l) { return l.status === SithLordStatus.ABSENT; })) {
	        actionCreator.send(new Actions_1.GET_SIDIOUS());
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = (function () {
	    ...
	    Store.prototype.writeAction = function (action) {
	...
	var Request = (function () {
	    ...
	    Object.defineProperty(Request.prototype, "pending", {
	        get: function () {
	    ...
	    Object.defineProperty(Request.prototype, "returnedSucessfully", {
	        get: function () {
	...
	var RequestAction = (function (_super) {
	    ...
	    */
	    RequestAction.prototype.send = function (writer) {
	        var _this = this;
	        writer(this);
	        this.req.send(function () { return writer(_this); });
	    };
	...
	var ActionCreator = (function () {
	    ...
	    ActionCreator.prototype.write = function (action) {
	        this.store.writeAction(action);
	    };
	    ActionCreator.prototype.send = function (requestAction) {
	...
	var Container = (function (_super) {
	    ...
	    function Container(props) {
	        ...
	        this.onAction = function () {
	            _this.setState(_this.getStoreState());
	        };
	    }
	    Container.prototype.getStoreState = function () {
	...
	var Immutable = (function () {
	    ...
	    Object.defineProperty(Immutable.prototype, "v", {
	        get: function () {
	            if (Array.isArray(this.obj)) {
	                return this.obj.slice();
	            }
	    ...
	    Immutable.prototype.set = function (f) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GET_SIDIOUS = (function (_super) {
	    ...
	    function GET_SIDIOUS() {
	        _super.call(this, 'http://localhost:3000/dark-jedis/3616');
	    }
	...
	exports.GET_SIDIOUS = GET_SIDIOUS;
	var GET_SITH_APPRENTICE = (function (_super) {
	    __extends(GET_SITH_APPRENTICE, _super);
	    function GET_SITH_APPRENTICE(url, masterId) {
	...
	exports.GET_SITH_APPRENTICE = GET_SITH_APPRENTICE;
	var GET_SITH_MASTER = (function (_super) {
	    __extends(GET_SITH_MASTER, _super);
	    function GET_SITH_MASTER(url, apprenticeId) {
	...
	exports.GET_SITH_MASTER = GET_SITH_MASTER;
	var RECEIVE_OBI_WORLD = (function (_super) {
	    __extends(RECEIVE_OBI_WORLD, _super);
	    function RECEIVE_OBI_WORLD(id, name) {
	        this.worldId = id;
	        this.worldName = name;
	        _super.call(this);
	    }
	...
	exports.RECEIVE_OBI_WORLD = RECEIVE_OBI_WORLD;
	var SCROLL_UP = (function (_super) {
	    __extends(SCROLL_UP, _super);
	    function SCROLL_UP() {
	        _super.apply(this, arguments);
	    }
	    SCROLL_UP.prototype.write = function (state) {
	        state.sithLords = SithLordsState.writeScrollUp(state.sithLords);
	    };
	    return SCROLL_UP;
	})(Flux_1.Action);
	exports.SCROLL_UP = SCROLL_UP;
	var SCROLL_DOWN = (function (_super) {
	    __extends(SCROLL_DOWN, _super);
	    function SCROLL_DOWN() {
	        _super.apply(this, arguments);
	    }
	    SCROLL_DOWN.prototype.write = function (state) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slot = (function (_super) {
	    ...
	    Slot.prototype.render = function () {
	        var color = (this.props.red) ? 'red' : null;
	        return (React.createElement("li", {"className": "css-slot", "style": { color: color }}, this.props.children));
	    };
	    return Slot;
	})(React.Component);
	var Sith = (function (_super) {
	    __extends(Sith, _super);
	    function Sith() {
	        _super.apply(this, arguments);
	    }
	    Sith.prototype.render = function () {
	        if (!this.props.name) {
	            return React.createElement(Slot, {"red": false});
	        }
	        return (React.createElement(Slot, {"red": this.props.onObiWansPlanet}, React.createElement("h3", {"key": "name"}, this.props.name), React.createElement("h6", {"key": "homeworld"}, "Homeworld: ", this.props.homeworld)));
	    };
	    return Sith;
	})(React.Component);
	var AppBlock = (function (_super) {
	    ...
	    AppBlock.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", {"className": "css-root"}, React.createElement("h1", {"className": "css-planet-monitor", "key": "monitor"}, "Obi-Wan currently on ", this.props.obiWanPlanet), React.createElement("section", {"className": "css-scrollable-list", "key": "list"}, React.createElement("ul", {"className": "css-slots", "key": "list"}, this.props.sith.map(function (jedi, index) { return React.createElement(Sith, React.__spread({"key": index}, jedi)); })), React.createElement("div", {"className": "css-scroll-buttons", "key": "buttons"}, React.createElement("button", {"key": "up", "disabled": this.props.scrollUpDisabled, "className": (!this.props.scrollUpDisabled) ? "css-button-up" : "css-button-up css-button-disabled", "onClick": function () {
	            if ((!_this.props.scrollUpDisabled)) {
	                _this.props.actionCreator.write(new Actions_1.SCROLL_UP());
	            }
	        }}), React.createElement("button", {"key": "down", "disabled": this.props.scrollDownDisabled, "className": (!this.props.scrollDownDisabled) ? "css-button-down" : "css-button-down css-button-disabled", "onClick": function () {
	            if ((!_this.props.scrollDownDisabled)) {
	                _this.props.actionCreator.write(new Actions_1.SCROLL_DOWN());
	            }
	        }})))));
	    };
	    return AppBlock;
