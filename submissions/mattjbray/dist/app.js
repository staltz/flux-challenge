...
Elm.Main.make = function (_elm) {
            ...
            return A2($Html.button,
              ...
              $Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                      ...
                                                      ,{ctor: "_Tuple2"
                                                       ...
                                                       ,_1: $Basics.not(_v15._2)}])),
              _v15._2 ? _L.fromArray([A2($Html$Events.onClick,
              address,
              Scroll(_v15._0))]) : _L.fromArray([])),
              _L.fromArray([]));}
         _U.badCase($moduleName,
         "between lines 326 and 333");
      }();
   });
   ...
   var maybeFetchNextJedi = function (currentPos) {
      return A2(maybeFetchJedi,
      currentPos + 1,
      function (_) {
         return _.apprentice;
      });
   };
   var maybeFetchPrevJedi = function (currentPos) {
      return A2(maybeFetchJedi,
      currentPos - 1,
      function (_) {
         return _.master;
   ...
   jediSlots) {
      return function () {
         ...
         var $ = function () {
            ...
            _U.badCase($moduleName,
            "between lines 244 and 251");
         }(),
         firstOrLast = $._0,
         apprenticeOrMaster = $._1;
         var jedi = firstOrLast(loadedJedis);
                    ...
                    return function () {
                         ...
                         return {ctor: "_Tuple2"
                                ...
                                ,_1: function () {
                                   ...
                                   {case "Just":
                                      return A3(fetchJedi,
                                        $Array.length(model.jediSlots) - scrollSpeed,
                                        newScrollPos,
                                        _v35._0);
                                      case "Nothing":
                                      return $Effects.none;}
                         ...
                         return {ctor: "_Tuple2"
                                ...
                                ,_1: function () {
                                   ...
                                   {case "Just":
                                      ...
                                      return $Effects.none;}
                                   _U.badCase($moduleName,
                                   "between lines 151 and 156");
                                }()};
                      }();}
                 _U.badCase($moduleName,
                 "between lines 143 and 171");
              }();
            case "SetJedi":
            return function () {
                 var offset = action._1 - model.scrollPos;
                 var adjustedPos = action._0 + offset;
                 return {ctor: "_Tuple2"
                        ,_0: A2(inBounds,
                        adjustedPos,
   ...
   _v39) {
      return function () {
         ...
         _L.fromArray([viewPlanetMonitor(_v39.world)
                      ,A3(viewJediList,
                      address,
                      _v39.jediSlots,
                      _v39.world)]));
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,maybeFetchNextJedi: maybeFetchNextJedi
                      ,maybeFetchPrevJedi: maybeFetchPrevJedi
                      ,canScroll: canScroll
                      ,onWorld: onWorld
                      ,view: view
