...
Elm.Main.make = function (_elm) {
   ...
   model) {
      return function () {
         ...
         A2(onWorld,
         newMJedi,
         model.world) ? _L.fromArray([abortAndSaveAllRequests]) : _L.fromArray([]));
      }();
   });
