...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SithUI = __webpack_require__(167);

	var _behaviour = __webpack_require__(168);
	...
	function fnReqJedi(url) {
	  return _jquery2['default'].get(url).done(function () {
	    return store.dispatch({ type: "listUpdate" });
	  });
	}
	store.replaceReducer((0, _behaviour.createBehaviour)(fnReqJedi).reducer);

	/* connect store to UI */
	store.subscribe(function () {
	  _react2['default'].render(_react2['default'].createElement(_SithUI.SithUI, { state: store.getState(),
	    dispatch: store.dispatch }), document.getElementById('app'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SithUI = (function (_React$Component) {
	  _inherits(SithUI, _React$Component);

	  function SithUI() {
	    _classCallCheck(this, SithUI);

	    _get(Object.getPrototypeOf(SithUI.prototype), "constructor", this).apply(this, arguments);
	  }

	  _createClass(SithUI, [{
	    key: "emit",
	    value: function emit(actionName) {
	    ...
	    value: function render() {
	      ...
	      var rows = _props$state.rows;
	      var currentPlanet = _props$state.currentPlanet;
	      var matchedSith = _props$state.matchedSith;
	      var canGoUp = !matchedSith && rows[0].masterUrl;
	      var canGoDown = !matchedSith && rows[4].apprenticeUrl;
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	            ...
	            rows.map(function (row, idx) {
	              return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                  "h6",
	                  null,
	                  row.homeworld ? "Homeworld: " + row.homeworld : ""
	                )
	              );
	            })
	          ),
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement("button", { className: "css-button-up" + (!canGoUp ? " css-button-disabled" : ""),
	              onClick: function () {
	                return canGoUp && _this.emit("scrollUp");
	              } }),
	            _react2["default"].createElement("button", { className: "css-button-down" + (!canGoDown ? " css-button-disabled" : ""),
	              onClick: function () {
	                return canGoDown && _this.emit("scrollDown");
	              } })
	          )
	        )
	      );
...
/***/ function(module, exports) {
	...
	exports.createBehaviour = createBehaviour;

	function createBehaviour(fnReqJedi) {
	  ...
	  var events = {
	    ...
	    "planetChanged": function planetChanged(state, _ref) {
	      var name = _ref.name;

	      state.currentPlanet = name;
	      state.matchedSith = state.rows.find(function (row) {
	    ...
	    "sithMatched": function sithMatched(state) {
	    ...
	    "listUpdate": function listUpdate(state) {
	      for (var i = 0; i < state.rows.length; i++) {
	        ...
	        state.matchedSith = state.rows.find(function (sith) {
	          return sith.homeworld === state.currentPlanet;
	        });
	    ...
	    "SithUI.scrollUp": function SithUIScrollUp(state) {
	      state.rows.splice(0, 0, EMPTY, EMPTY);
	      state.rows.splice(5, 2).forEach(function (deleted) {
	        return deleted.abort && deleted.abort();
	      });
	      return events["listUpdate"](state);
	    },

	    "SithUI.scrollDown": function SithUIScrollDown(state) {
	      state.rows.splice(0, 2).forEach(function (deleted) {
	        return deleted.abort && deleted.abort();
	      });
