...
/***/ function(module, exports, __webpack_require__) {
	...
	var el = _react2['default'].createElement(_AppContainer2['default'], {});
	var root = document.getElementById('app-root');
	_reactDom2['default'].render(el, root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fluxUtils = __webpack_require__(158);

	var _CurrentPlanetSocket = __webpack_require__(175);

	var _CurrentPlanetSocket2 = _interopRequireDefault(_CurrentPlanetSocket);

	var _CurrentPlanetStore = __webpack_require__(179);

	var _CurrentPlanetStore2 = _interopRequireDefault(_CurrentPlanetStore);
	...
	var _SithStore = __webpack_require__(180);

	var _SithStore2 = _interopRequireDefault(_SithStore);
	...
	var AppContainer = (function (_Component) {
	  ...
	  _createClass(AppContainer, [{
	    ...
	    value: function componentWillMount() {
	      _CurrentPlanetSocket2['default'].init();
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      _CurrentPlanetSocket2['default'].close();
	    }
	  }, {
	    key: 'render',
	    ...
	    value: function _scrollUp() {
	      _Dispatcher2['default'].dispatch({ type: 'scroll-up' });
	    }
	  }, {
	    key: '_scrollDown',
	    value: function _scrollDown() {
	      _Dispatcher2['default'].dispatch({ type: 'scroll-down' });
	    }
	  }], [{
	    key: 'getStores',
	    value: function getStores() {
	      return [_CurrentPlanetStore2['default'], _SithStore2['default']];
	    }
	  }, {
	    key: 'calculateState',
	    value: function calculateState() {
	      return {
	        currentPlanet: _CurrentPlanetStore2['default'].getState(),
	        siths: _SithStore2['default'].getState()
	      };
	    }
	  }]);
	...
	exports['default'] = _fluxUtils.Container.create(AppContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderPlanetMonitor(props) {
	  return _react2['default'].createElement(
	    'h1',
	...
	function renderSithListElements(props) {
	  var currentPlanet = props.currentPlanet;

	  return props.siths.map(function (sith) {
	    var requestID = sith.requestID;
	    var name = sith.name;
	    var homeworldName = sith.homeworldName;
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'h6',
	        null,
	        homeworldName ? 'Homeworld: ' + homeworldName : ''
	      )
	    );
	  });
	}
	...
	function renderUpButton(props) {
	  ...
	  if (disabled) {
	    ...
	    return _react2['default'].createElement('button', { className: 'css-button-up', onClick: props.onScrollUp });
	  }
	}
	...
	function renderDownButton(props) {
	  ...
	  if (disabled) {
	    ...
	    return _react2['default'].createElement('button', { className: 'css-button-down', onClick: props.onScrollDown });
	  }
	}

	function inTheDangerZone(props) {
	  return props.siths.some(function (sith) {
	    return sith.homeworldName === props.currentPlanet;
	  });
	}
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.Container = __webpack_require__(159);
	module.exports.MapStore = __webpack_require__(163);
	module.exports.Mixin = __webpack_require__(174);
	module.exports.ReduceStore = __webpack_require__(164);
	module.exports.Store = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStoreGroup = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxReduceStore = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStore = __webpack_require__(165);

	var abstractMethod = __webpack_require__(172);
	var invariant = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fbemitter = {
	  EventEmitter: __webpack_require__(167)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmitterSubscription = __webpack_require__(168);
	var EventSubscriptionVendor = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventSubscription = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = { init: init, close: close };
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CurrentPlanetStore = (function (_ReduceStore) {
	  _inherits(CurrentPlanetStore, _ReduceStore);

	  function CurrentPlanetStore() {
	    _classCallCheck(this, CurrentPlanetStore);

	    _get(Object.getPrototypeOf(CurrentPlanetStore.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(CurrentPlanetStore, [{
	    key: 'getInitialState',
	  ...
	  return CurrentPlanetStore;
	})(_fluxUtils.ReduceStore);

	exports['default'] = new CurrentPlanetStore(_Dispatcher2['default']);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutable = __webpack_require__(181);

	var _immutable2 = _interopRequireDefault(_immutable);

	var _fluxUtils = __webpack_require__(158);

	var _Sith = __webpack_require__(182);

	var _Sith2 = _interopRequireDefault(_Sith);

	var _SithDataManager = __webpack_require__(183);

	var _SithDataManager2 = _interopRequireDefault(_SithDataManager);

	var MAX_LENGTH = 5;
	var EMPTY_SITH = new _Sith2['default']();
	var DEFAULT_LIST = _immutable2['default'].List(new Array(MAX_LENGTH).fill(EMPTY_SITH));

	var SithStore = (function (_ReduceStore) {
	  _inherits(SithStore, _ReduceStore);

	  function SithStore() {
	    _classCallCheck(this, SithStore);

	    _get(Object.getPrototypeOf(SithStore.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(SithStore, [{
	    key: 'getInitialState',
	    value: function getInitialState() {
	      var requestID = _SithDataManager2['default'].loadDarthSidius();
	      return DEFAULT_LIST.set(2, new _Sith2['default']({ requestID: requestID }));
	    }
	  }, {
	    key: 'reduce',
	    value: function reduce(state, action) {
	...
	function sithLoaded(state, next) {
	 ...
	 */
	function shift2(state) {
	  _SithDataManager2['default'].abort(state.get(0).requestID);
	  _SithDataManager2['default'].abort(state.get(1).requestID);
	 ...
	 */
	function pop2(state) {
	  _SithDataManager2['default'].abort(state.get(state.size - 1).requestID);
	  _SithDataManager2['default'].abort(state.get(state.size - 2).requestID);
	 ...
	 */
	function loadSiths(state) {
	  return state.map(function (sith, index, list) {
	    ...
	    if (index > 0) {
	      var prev = list.get(index - 1);
	      if (prev.apprenticeID) {
	        var requestID = _SithDataManager2['default'].loadSith(prev.apprenticeID);
	        return new _Sith2['default']({ requestID: requestID });
	      }
	    }
	    ...
	    if (index < list.size - 1) {
	      ...
	      if (next.masterID) {
	        var requestID = _SithDataManager2['default'].loadSith(next.masterID);
	        return new _Sith2['default']({ requestID: requestID });
	      }
	    }
	 ...
	 */
	function abortIfInDanger(state, currentPlanet) {
	  var inDanger = state.some(function (sith) {
	    return sith.homeworldName === currentPlanet;
	  });
	  if (inDanger) {
	    return state.map(function (sith) {
	      // This is one way to check if the request is in flight.
	      if (sith.requestID && !sith.name) {
	        _SithDataManager2['default'].abort(sith.requestID);
	        return EMPTY_SITH;
	      }
	      return sith;
	    });
	...
	function getCurrentPlanet() {
	  _Dispatcher2['default'].waitFor([_CurrentPlanetStore2['default'].getDispatchToken()]);
	  return _CurrentPlanetStore2['default'].getState();
	}

	exports['default'] = new SithStore(_Dispatcher2['default']);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sith = (function (_record) {
	  _inherits(Sith, _record);

	  function Sith() {
	    _classCallCheck(this, Sith);

	    _get(Object.getPrototypeOf(Sith.prototype), 'constructor', this).apply(this, arguments);
	  }

	  return Sith;
	})(record);

	exports['default'] = Sith;
	;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SithDataManager = {
	  ...
	  loadDarthSidius: function loadDarthSidius() {
	    return SithDataManager.loadSith('3616');
	  },

	  loadSith: function loadSith(id) {
	    var requestID = counter++;
	    var request = (0, _xhr2['default'])({ uri: URL + id }, function (err, resp, body) {
	...
	exports['default'] = SithDataManager;
	module.exports = exports['default'];
